#!/bin/bash
clear
echo -e "\e[4;31m RamjeeProductions !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m TBomb \e[0m"
echo "Press Enter To Continue"
read a1
if [[ -s update.rampage ]]; then
    ...
    echo This Script Was Made By rampage > update.rampage
...
do
    ...
    echo -e "\e[4;34m This Bomber Was Created By rampage \e[0m"
    echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
    echo -e "\e[1;32m           Mail: ramjeepentakota@gmail.com \e[0m"
    echo -e "\e[4;32m   YouTube Page: https://www.youtube.com/ramjeetechchannel \e[0m"
    echo " "
    ...
    if [ $ch -eq 1 ]; then
        ...
        clear
        echo -e "\e[1;32m"
        echo 'Call Bomb By rampage' > call.xxx
        ...
        git clone https://github.com/Therampage/TBomb
        ...
        echo -e "\e[1;33m      [*]  rampage  \e[1;31m"
        echo "         [-] Mail At: ramjeepentakota425@gmail.com"
        ...
        figlet TBomb
        echo -e "\e[1;34m Created By \e[1;32m"
        toilet -f mono12 -F border rampage
        echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
        echo -e "\e[1;32m           Mail: ramjeetechchannel@gmail.com \e[0m"
        echo -e "\e[1;32m       Whatsapp: 9395123493 \e[0m"
        echo -e "\e[4;32m   YouTube Page: https://www.youtube.com/ramjeetechchannel \e[0m"
        echo " "
        exit 0
    else
